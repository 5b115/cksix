    ...
    <dl class="leftmenu">
		...
		<dd>
			...
			<ul class="menuson">
				...
				<li><cite></cite><a href="/pt/view/specialty04.jsp" target="rightFrame">学生填报概况</a><i></i></li>
				<li><cite></cite><a href="/pt/view/specialty04_1.jsp" target="rightFrame">志愿填报详情</a><i></i></li>
